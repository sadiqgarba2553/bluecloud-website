...
const AuthModal = ({ isOpen, onClose }) => {
  const {
    currentUser, isPro, openSubscriptionModal,
        ...
        {currentUser ? (
            ...
            <div className="spotify-profile-header">
              <div className="spotify-avatar-container">
                {currentUser.photoURL ? (
                  <img src={currentUser.photoURL} alt={currentUser.displayName} className="spotify-avatar-img" />
                ) : (
          ...
          <>
            <div className="auth-header">
              <img src="/logo.png" alt="Quranly Logo" className="auth-brand-logo" />
